...
| `mcp-status` | Official stdio and in-memory MCP clients exercise the server. Mos Eisley's MCP client remains unimplemented in the inspected checkout. | tests/test_mcp.py; tests/test_postgres.py; README.md | 2026-09-06 |
...
variables, role grants/cloud TLS validation, Mos Eisley client integration and target
